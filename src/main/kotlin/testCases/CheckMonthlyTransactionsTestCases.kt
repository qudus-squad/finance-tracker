...
class TestMonthlyTransactions(dataSource: InMemoryStorage) : ShowMonthlyTransactions(dataSource) {

    fun testableGetTransactions(month: String, year: Int): List<Transaction> {
...
fun checkMonthlyTransactionsTestCases() {
    ...
    val monthlySheet = TestMonthlyTransactions(storage)
    ...
    val result1 = monthlySheet.testableGetTransactions("JAN", 2025)
    ...
    val result2 = monthlySheet.testableGetTransactions("JAN", 2025)
    ...
    val result3 = monthlySheet.testableGetTransactions("JAN", 2025)
    ...
    val result4 = monthlySheet.testableGetTransactions("APR", 2026)
    check("Different year", result4.size == 1 && result4[0].timeStamp == dateApr2026, true)

    val result5 = monthlySheet.testableGetTransactions("XYZ", 2025)
    check("Invalid month input", result5.isEmpty(), true)

    val result6 = monthlySheet.testableGetTransactions("DEC", 2025)
    ...
    val result7 = monthlySheet.testableGetTransactions("JAN", 2025)
